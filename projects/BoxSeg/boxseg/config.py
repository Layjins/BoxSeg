...
def add_box_teacher_config(cfg):
    ...
    # new configs
    cfg.MODEL.USE_VFL = False
    cfg.MODEL.PROTO_ON = False
    cfg.MODEL.WITH_PROTOTYPE_LOSS = False
    cfg.MODEL.COPYPASTE_ON = False
    cfg.MODEL.COPYPASTE_TYPE = "simple"
    cfg.MODEL.BOX_TEACHER.RESIZE_IMAGES = True
    cfg.MODEL.BOX_TEACHER.MASK_AFFINITY_BINARY = True
    cfg.MODEL.BOX_TEACHER.TEACHER_WITH_NMS = True
    cfg.MODEL.BOX_TEACHER.DYNAMIC_MASK_THRESH = False
